...
public class AnagramCoreApiClientTest {
    ...
    private static void setWords(final WordEntity... anagrams) {
    ...
    @Before
    public void setUp() {
        apiClient = new AnagramCoreApiClient(AbstractDictionarCoreApiClient.DEFAULT_DICTIONAR_API_SERVER_FORMAT,
                                             1000,
                                             true);
        AnagramCoreApiClientTest.setWords(AnagramCoreApiClientTest.anagram1,
                                          AnagramCoreApiClientTest.anagram2,
                                          AnagramCoreApiClientTest.anagram3,
                                          AnagramCoreApiClientTest.anagram4);
    }
    ...
    //
    //	@Test(expected=IllegalArgumentException.class)
    //	public void should_test_getImages_with_no_pageNumber_and_nbItemPerPage_when_managerList_is_null() throws
    // Exception {
    //		//when
    ...
    //
    //	@Test(expected=IllegalArgumentException.class)
    //	public void should_test_getImages_with_no_pageNumber_and_nbItemPerPage_when_hostname_is_null() throws
    // Exception {
    //		//Given
    //		final ArrayList<Long> managerIds = new ArrayList<Long>();
    //		managerIds.add(1L);
    ...
    //
    //		//when
    //		when(apiClient.getImageArchive("apiHost", null, null, "search", "order", DESC,
    // managerIds)).thenReturn(listOfImage);
    //		final List<ImageEntity> entities = apiClient.getImageArchive("apiHost", "search", "order", DESC,
    // managerIds);
    //
    //		//Then
    //		assertThat(entities).containsExactly(ImageCoreApiClientTest.ime1, ImageCoreApiClientTest.ime2,
    // ImageCoreApiClientTest.ime3, ImageCoreApiClientTest.ime4);
    //
    //	}
    //
    //	@Test(expected=IllegalArgumentException.class)
    ...
    //
    //		//when
    //		when(apiClient.getImageArchive("apiHost", 1, null, "search", "order", DESC,
    // managerIds)).thenReturn(listOfImage);
    //		final List<ImageEntity> entities = apiClient.getImageArchive("apiHost", 1,"search", "order", DESC,
    // managerIds);
    //
    //		//Then
    //		assertThat(entities).containsExactly(ImageCoreApiClientTest.ime1, ImageCoreApiClientTest.ime2,
