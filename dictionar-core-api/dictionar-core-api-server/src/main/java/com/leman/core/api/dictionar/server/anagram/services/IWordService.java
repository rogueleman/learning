...
//	 * @return              A list of ImageMetaEntity
//	 */
//	public List<WordEntity> getArchives(Integer currentPage, String search, String order, Sort sort, List<Long> managerId);
//
//
//	/**
//	 * Allows to get archives with parameters
...
//	 * @return              A list of ImageMetaEntity
//	 */
//	public List<WordEntity> getArchives(Integer currentPage, Integer nbItemPerPage, String search, String order, Sort sort, List<Long> managerId);
//
//
//	/**
//	 * Retrieve Image
...
//	 * @throws IOException
//	 */
//	public WordEntity postImage(final Long managerId,  final Long clientId, final Long clientImageQuotaUsed, final Long clientImageMaxUsed, final String name, final String description, final InputStream uploadedInputStream, final FormDataContentDisposition fileDetail) throws IOException;
//
//
//	/**
//	 * 
